...
export function ProfilePage() {
  ...
  const menuItems = [
    ...
    { icon: MapPin, label: 'Alamat Tersimpan', path: '/profile/addresses' },
        ...
        <div className="bg-white p-6 mb-2">
          ...
          <div className="mt-4 pt-4 border-t space-y-2">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-gray-600">081234567890</span>
            </div>
            <div className="flex items-center gap-2 text-sm">
              <MapPin className="w-4 h-4 text-gray-400" />
              <span className="text-gray-600">Jl. Sudirman No. 123, Jakarta Selatan</span>
            </div>
          </div>
        </div>
